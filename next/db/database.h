...
class TOGGL_INTERNAL_EXPORT Database {
 public:
    ...
    error SaveUser(locked<UserModel> &user, bool with_related_data,
                   std::vector<ModelChange> *changes);

    error LoadTimeEntriesForUpload(UserModel *user);
 ...
 private:
    ...
    error selectCompressedTimelineBatchForUpload(
        ...
        std::vector<TimelineEventModel> *timeline_events);
